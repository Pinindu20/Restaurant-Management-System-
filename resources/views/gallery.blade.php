					...
					@if ($i <= $c)
                        ...
                        @if ($i==$a)
                            ...
                            <div class="col-md-6 col-sm-6 fh5co-gallery_item">
                                <div class="fh5co-bg-img fh5co-gallery_big" style="background-image: url(/foodimage/{{ $data[$i]->image }});" data-trigger="zoomerang"></div>
                            </div>
                            ...
                            @if($i < $a)
								...
								@if($i%2==0)
									<div class="col-md-3 col-sm-3 fh5co-gallery_item">
										...
										<div class="fh5co-bg-img" style="background-image: url(/foodimage/{{ $data[$i]->image }});" data-trigger="zoomerang"></div>
										<div class="fh5co-bg-img" style="background-image: url(/foodimage/{{ $data[$i+1]->image }});" data-trigger="zoomerang"></div>
									</div>
								@endif
